...
<html>
    <head>
        <title>Admin - Members pangMembers</title>
            ...
            <div class="row">
                <div class="col-md-2">
                    <div id="list-example" class="list-group">
                      <a class="list-group-item list-group-item-action active" href="/">Members</a>
                      <a class="list-group-item list-group-item-action" href="/groups">Groups</a>
